...
export class crmdiscoapiconfig  {
    APIUrl: string;
    AccessToken?: string;
};

export class crmdiscoorgdetaillist  {
   List:crmdiscoorgdetail[];
   Count:number;
};
export class crmdiscoorgdetail  {
    Id: string;
    UniqueName: string;
    UrlName:string;
    FriendlyName:string;
...
export class crmdiscoapi {
    private config: crmdiscoapiconfig;
    private node: boolean;
    private https: any;
    private urllib: any;
    private _GetHttpRequest: any;

    constructor(config: crmdiscoapiconfig) {
        this.config = config;
    ...
    public GetInstances(): Promise<crmdiscoorgdetaillist> {
    ...
    public Get( orgID: string,orgName: string): Promise<crmdiscoorgdetail> {
        return new Promise((resolve, reject) => {
            let url = null;
            if (orgID != null) {
